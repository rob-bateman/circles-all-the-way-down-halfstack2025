...
class keyRenderer {
    ...
    setCurrentKey(key)
    {
        ...
        if (this.keyset.hasOwnProperty(key)){
        	sliderTerms.value(sliderTerms.value() + this.keyset[key]);
            clearPath();
        }
    }
